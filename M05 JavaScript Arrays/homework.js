...
function numeroMasGrande(arrayOfNums) {
   ...
   // Tu código:
   var numeroMasGrande = arrayOfNums [1]
...
function todosIguales(array) {
   ...
   for(let i = 1; i < array.length; i++){
      if(todosIguales === array[i]) todosIguales = array[i]
      else return false
   }
   return true
}
...
function mesesDelAño(array) {
   ...
   for(var i = 0; i < array.length; i++){
      if(array[i] === 'Enero' || array[i] === 'Marzo' || array[i] === 'Noviembre'){
         mesesAEncontrar.push(array[i]);
      }
   }
   if(mesesAEncontrar.length === 3){
      return mesesAEncontrar
   }
   else{
...
function mayorACien(array) {
   ...
   for(let num of array){
      if (num > 100) mayoresCien.push(num)
   }
   return mayoresCien
}
/* ----------------------------------------------------------------------------------
